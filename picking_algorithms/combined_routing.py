...
def combined_routing(sku_objects, start_at_front=True):
    ...
    After leaving an aisle (at the front or at the rear end), 
    a choice between the two alternatives ending at the back and a choice between the two alternatives ending at the front has to be made. 
